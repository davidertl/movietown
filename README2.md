...
**A mediastack.guide-inspired two-site media stack** split into:
...
This repo provides Docker Compose files for both locations, example environment files, an automated setup script, and a step-by-step flow. Visit [mediastack.guide](https://mediastack.guide) for the comprehensive reference and [their GitHub](https://github.com/geekau/mediastack) for the inspiration behind this variant.
